...
class MGM_Links(SQLModel, table=True):
    ...
    def create_with_url(cls, member_id: uuid.UUID) -> "MGM_Links":
        url = f"https://www.clickbus.com.br/login?utm_source=automatic&utm_medium=crm&utm_campaign=member-get-member-convidado&utm_term=invited&utm_content={member_id}&responsive=true"
